...
class YearCalendarView: UIView, YearCollectionViewProtocol {
    ...
    override init(frame: CGRect) {
        ...
        collectionViewYear = YearCollectionView(frame: CGRect(x: 10, y: 10 , width: self.frame.size.width - 20, height: self.frame.size.height - 20), collectionViewLayout: YearCollectionViewFlowLayout())
